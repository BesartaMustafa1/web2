...
=======
      ...
      <?php 
      // Retrieve the username from session storage $username = isset($_SESSION["username"]) 
      ?>
      $_SESSION["username"] : null; 
      // Display the welcome message with the username if it exists if ($username) { echo '<script>'; 
      echo 'document.getElementById("username").textContent = "'.$username.'";'; 
      echo 'document.getElementById("welcomeMessage").style.display = "block";';
       echo '</script>'; } 
 ...
 <head> 
  ...
  <meta charset="UTF-8">
   ...
   <title>TL</title>
    ...
    <link rel="stylesheet" href="../footer/footer.css"> 
    <link rel="stylesheet" href="../courses/courses.css">
     <link rel="stylesheet" href="/launching/launching.html">
      <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"
       ...
       <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous"> 
                    ...
                    <li><a href="../spaces/spaces.html">Study places</a></li>
                     <li><a href="../launching/launching.html">Launching soon</a></li>
                      <li><a href="../aboutus/aboutus.html">About us</a></li> 
                       ...
                       <div class="social">
                         <i class="fa-solid fa-magnifying-glass"></i> 
                         <i class="fa-solid fa-heart"></i> </div> <div 
                         class="user-info" id="welcomeMessage" style="display: none;">
                          <span>Welcome, <span id="username"></span></span>
                           </div> 
                           <div class="signin"> <svg xmlns="http://www.w3.org/2000/svg" 
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                             stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in"> 
                             <path d="M19 12H5M12 19l-7-7 7-7"/> </svg> <a href="../signup/signup.html" 
                             style="text-decoration: none; color:black"><span>Sign In</span></a> 
                             </div> 
                             </nav> 
                             </header> --> 
                                    ...
                                    <link rel="stylesheet" href="launching.css">
                                     <div class="container"> 
                                      <div class="content"> 
                                        ...
                                        <div class="launch-time">
                                           <div> <p id="days">00</p> 
                                            <span>Days</span> </div> <div> <p id="hours">00</p> 
                                              <span>Hours</span> </div> <div> <p id="minutes">00</p>
                                                 <span>Minutes</span> </div> <div> <p id="seconds">00</p>
                                                   <span>Seconds</span> </div> </div> 
<!---- <a href="courses.html" class="button">Learn More<img src="triangle.png"></a>-->
 <a href="../courses/courses.html" class="button">Learn More<img src="triangle.png"></a> 
 </div> <img src="rocket.png" class="rocket"> </div> 
 <!-- <script> // Retrieve the username from session storage var username = sessionStorage.getItem("username");
   // Display the welcome message with the username if it exists if (username)
    { document.getElementById("username").textContent = username; document.getElementById("welcomeMessage").style.display = "block"; }
     // Function to handle sign-out action function signOut() {
       // Clear the session storage sessionStorage.removeItem("username");
        // Redirect to the login page window.location.href = "home2.html"; }
         </script> <script> $('#header').load('../header/header.html'); </script>
          <script> var countDownDate = new Date(" May 11, 2024 00:00:00").getTime(); var x = setInterval(function(){ var now = new Date().getTime(); 
            var distance = countDownDate - now; var days = Math.floor(distance / (1000 * 60 * 60 *24));
             ...
             document.getElementById("minutes").innerHTML = minutes;
              document.getElementById("seconds").innerHTML = seconds; 
              if(distance < 0){ clearInterval(x); document.getElementById("days").innerHTML = "00"; 
              document.getElementById("hours").innerHTML = "00"; 
              document.getElementById("minutes").innerHTML = "00";
               document.getElementById("seconds").innerHTML = "00"; 
              } 
            ...
            <iframe src="../footer/footer.php" width=100% height="450vh"></iframe>
             </body> </html> <?php include "../cookies\cookiefolder\cookies/Cookies.php";
              ?>
...
>>>>>>> 9b96522c29343043ae7d973410137403333b3fd5
