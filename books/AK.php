    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="AK.jpg" alt="Product Image">
            </div>
            <div class="product-details">
                <h2 class="product-title">Ana Karenina</h2>
                ...
                <form class="cart-form" onsubmit="addToCart(event)">
                    <input type="hidden" id="item_id" value="11">
                    <input type="hidden" id="item_name" value="Ana Karenina">
                    <input type="hidden" id="item_price" value="12.99">
                    <div class="quantity">
