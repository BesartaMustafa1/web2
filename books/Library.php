...
<div id="header"> </div><script>
    ...
    <div class="product-container">
        <div class="product-image">
            <img src="../books/library.png" alt="Product Image">
        </div>
        <div class="product-details">
            <h1 class="product-title">The Underground Library</h1>
            ...
            <form class="cart-form" action="../" method="post" enctype="multipart/form-data">
                ...
                <button class="add-to-cart-btn" type="button" onclick="addToCart(1, 'The Underground Library', 20)">Add to Cart</button>
            </form>
        </div>
    </div>
    <script>
