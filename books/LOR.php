    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="LOR.jpg" alt="Product Image">
            </div>
            <div class="product-details">
                <h2 class="product-title">Lord of the Rings</h2>
                ...
                <form class="cart-form" onsubmit="addToCart(event)">
                    <input type="hidden" id="item_id" value="6">
                    <input type="hidden" id="item_name" value="Lord of the Rings">
