    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="gabreil.jpg" alt="Product Image">
            </div>
            <div class="product-details">
                <h2 class="product-title">One Hundred Years of Solitude</h2>
                ...
                <form class="cart-form" onsubmit="addToCart(event)">
                    ...
                    <input type="hidden" id="item_name" value="One Hundred Years of Solitude">
                    <input type="hidden" id="item_price" value="15.99">
                    <div class="quantity">
