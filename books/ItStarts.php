    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="itstarts.jpg" alt="Product Image">
            </div>
            <div class="product-details">
                <h2 class="product-title">It Starts With Us</h2>
                ...
                <form class="cart-form" onsubmit="addToCart(event)">
                    <input type="hidden" id="item_id" value="7">
                    <input type="hidden" id="item_name" value="It Starts With Us">
                    <input type="hidden" id="item_price" value="24.99">
                    <div class="quantity">
